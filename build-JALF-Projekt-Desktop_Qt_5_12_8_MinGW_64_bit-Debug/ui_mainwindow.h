...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(390, 263);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        widget = new QWidget(centralwidget);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(60, 30, 271, 161));
        ...
        cmdEssenspl = new QPushButton(widget);
        cmdEssenspl->setObjectName(QString::fromUtf8("cmdEssenspl"));

        verticalLayout->addWidget(cmdEssenspl);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        cmdEssenspl->setText(QApplication::translate("MainWindow", "Essensplanung", nullptr));
    } // retranslateUi
